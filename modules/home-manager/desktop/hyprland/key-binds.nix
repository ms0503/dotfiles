...
let
  ...
  inherit (lib) mkIf mkLuaInline optionals;
    ...
    wayland.windowManager.hyprland.settings =
      ...
      in
      {
        bind = builtins.concatLists [
          ...
          (optionals (cfgWl.shell == "noctalia") [
            (mkBind "${mainMod} + SHIFT + M" (execCmd "uwsm app -- noctalia msg session logout"))
            (mkBind "${mainMod} + SHIFT + S" (execCmd "uwsm app -- noctalia msg screenshot-region"))
            (mkBind "${mainMod} + A" (execCmd "uwsm app -- noctalia msg panel-toggle control-center"))
            (mkBind "${mainMod} + Comma" (execCmd "uwsm app -- noctalia msg settings-toggle"))
            (mkBind "${mainMod} + L" (execCmd "uwsm app -- noctalia msg session lock"))
            (mkBind "${mainMod} + Print" (execCmd "uwsm app -- noctalia msg screenshot-fullscreen all"))
            (mkBind "${mainMod} + S" (execCmd "uwsm app -- noctalia msg panel-toggle launcher"))
            (mkBind "${mainMod} + X" (execCmd "uwsm app -- noctalia msg session lock-and-suspend"))
            (mkBind "${subMod} + Tab" (execCmd "uwsm app -- noctalia msg window-switcher"))
            (mkBind "Print" (execCmd "uwsm app -- noctalia msg screenshot-fullscreen"))
            (mkLockedBind "XF86AudioMicMute" (execCmd "uwsm app -- noctalia msg mic-mute"))
            (mkLockedBind "XF86AudioMute" (execCmd "uwsm app -- noctalia msg volume-mute"))
            (mkLockedBind "XF86AudioNext" (execCmd "uwsm app -- noctalia msg media next"))
            (mkLockedBind "XF86AudioPlay" (execCmd "uwsm app -- noctalia msg media toggle"))
            (mkLockedBind "XF86AudioPrev" (execCmd "uwsm app -- noctalia msg media previous"))
            (mkLockedRepeatingBind "XF86AudioLowerVolume" (execCmd "uwsm app -- noctalia msg volume-down"))
            (mkLockedRepeatingBind "XF86AudioRaiseVolume" (execCmd "uwsm app -- noctalia msg volume-up"))
            (mkLockedRepeatingBind "XF86MonBrightnessDown" (execCmd "uwsm app -- noctalia msg brightness-down"))
            (mkLockedRepeatingBind "XF86MonBrightnessUp" (execCmd "uwsm app -- noctalia msg brightness-up"))
          ])
        ];
      };
  };
